...
namespace ZeroC.IceVisualStudio
{
    class MSBuildUtils
    {
        ...
        public static Project LoadedProject(String path)
        {
            ...
            ICollection<Project> projects = ProjectCollection.GlobalProjectCollection.GetLoadedProjects(path);
        ...
        public static bool HasImport(Project project, String path)
        {
            return project.Xml.Imports.FirstOrDefault(p => p.Project.Equals(path)) != null;
        }

        public static bool AddProjectFlavorIfNotExists(Project project, String flavor)
        {
        ...
        public static bool RemoveProjectFlavorIfExists(Project project, String flavor)
        {
            ProjectPropertyElement property = project.Xml.Properties.FirstOrDefault(
                p => p.Name.Equals("ProjectTypeGuids"));
        ...
        public static bool HasProjectFlavor(Project project, String flavor)
        {
            ProjectPropertyElement property = project.Xml.Properties.FirstOrDefault(
                p => p.Name.Equals("ProjectTypeGuids"));
        ...
        public static bool IsIceBuilderEnabeld(Project project)
        {
            bool value = false;
        ...
        public static bool AddIceBuilderToProject(Project project)
        {
            bool modified = false;
            if (project != null)
            {
        ...
        public static bool RemoveIceBuilderFromProject(Project project)
        {
            bool modified = false;
            if(project != null)
            {
